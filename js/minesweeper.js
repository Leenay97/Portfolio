$(function () {
    ...
    $('.game__field-cell').on('click', function () {
        if (k == 1) {
            ...
            console.log(firstClickCol);
            var firstClickRow = Math.floor((+this.id / 10) % 10);
            console.log(firstClickRow);
            while (bombCount < 10) {
    ...
    function open(row, col) {
        ...
        console.log(isValid(cell.className));
    ...
    $('.game__face').on('click', function () {
        nullCells();
        var removeCells =  document.getElementsByClassName('game__field-cell');
        removeCells.classList.remove('mine1', 'mine2', 'mine3', 'mine3', 'mine4', 'mine5', 'bomb');
